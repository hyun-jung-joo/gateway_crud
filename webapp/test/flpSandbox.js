		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#syncc22gatewaycrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc22gatewaycrud-display": {
								"semanticObject": "syncc22gatewaycrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c22.gateway.crud",
									"url": sap.ui.require.toUrl("sync/c22/gateway/crud")
								}
							}
						}
					}
